let vassouraAnimada1 = document.getElementById('vassoura1');
let vassouraAnimada2 = document.getElementById('vassoura2');
let vassouraAnimada3 = document.getElementById('vassoura3');
